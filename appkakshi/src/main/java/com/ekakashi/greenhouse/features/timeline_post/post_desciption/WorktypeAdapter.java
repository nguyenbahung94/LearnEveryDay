...
public class WorktypeAdapter extends RecyclerView.Adapter<WorktypeAdapter.PostDescriptionViewHolder> {

    private ArrayList<WorkTypeResponse.WorkType> list;
    private FilterInterface.AutoTurnBack autoTurnBack;
    private LayoutInflater mLayoutInflater;

    public WorktypeAdapter(Context context, ArrayList<WorkTypeResponse.WorkType> list, FilterInterface.AutoTurnBack autoTurnBack) {
        this.list = list;
    ...
    public void onBindViewHolder(final PostDescriptionViewHolder holder, int position) {
        final WorkTypeResponse.WorkType item = list.get(position);
    ...
    private void clearListSelected() {
        for (WorkTypeResponse.WorkType item : list) {
