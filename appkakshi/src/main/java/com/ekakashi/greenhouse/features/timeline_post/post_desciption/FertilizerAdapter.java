...
public class FertilizerAdapter extends RecyclerView.Adapter<FertilizerAdapter.PostDescriptionViewHolder> {

    private ArrayList<FertilizerResponse.Fertilizer> list;
    private FilterInterface.AutoTurnBack autoTurnBack;
    private LayoutInflater mLayoutInflater;

    public FertilizerAdapter(Context context, ArrayList<FertilizerResponse.Fertilizer> list, FilterInterface.AutoTurnBack autoTurnBack) {
        this.list = list;
    ...
    public void onBindViewHolder(final PostDescriptionViewHolder holder, int position) {
        final FertilizerResponse.Fertilizer item = list.get(position);
        holder.tvPostDescription.setText(item.getDescription());
    ...
    private void clearListSelected() {
        for (FertilizerResponse.Fertilizer item : list) {
